...
<script src="{{asset('js/geo_data.js')}}"></script>
        ...
        <link rel="stylesheet" href="{{asset('plugins/pnotify.custom.min.css')}}">
        <link rel="stylesheet" href="{{asset('plugins/pnotify.custom.min.js')}}">
  ...
  <ul class="navbar-nav mr-auto"> 
      <li class="nav-item">
        <a class="nav-link" href="{{route('carts')}}">Cart 
            <span class="badge badge-danger">{{ Auth::check() == true ? App\Cart::count(Auth::id()):'' }}</span>
        </a>
      </li>
    </ul>
</div>
